		...
		<form class="modal-content form_input" id="form_input">
			...
			<div class="modal-body">
				<div class="row mb-3">
					...
					<div class='col-md-12'>
						<?php $label = 'icon'; ?>
						<label for="nameBackdrop" class="form-label" style="justify-content: space-between;display: flex">
							<span><?= getLabel($label) ?></span>
							<a href="<?=base_url().'icon'?>" target="_blank">Lihat Icon</a>
						</label>
						<input type="text" name="<?= $label ?>" id="<?= $label ?>" class="form-control">
					</div>

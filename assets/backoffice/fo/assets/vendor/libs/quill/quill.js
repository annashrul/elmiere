                        ...
                        return function(t) {
                                    ...
                                    return i(t, null, [{
                                        ...
                                        i(t, [{
                                            ...
                                            value: function(t, e, n, r, i) {
                                                var l, a = this, s = E(t, e, n, r, i), u = o(s, 4);
                                                return t = u[0],
                                                    e = u[1],
                                                    l = u[2],
                                                    i = u[3],
                                            ...
                                            key: "insertText",
                                            value: function(t, e, n, r, i) {
                                                var l, a = this, s = E(t, 0, n, r, i), u = o(s, 4);
                                                return t = u[0],
                                                    l = u[2],
                                                    i = u[3],
                                                    w.call(this, (function() {
                                        ...
                                        void 0 === u && (u = 1 / 0),
                                            function l(u, y) {
                                                ...
                                                if (t(u, n))
                                                    ...
                                                    if (d && e.isBuffer(u))
                                                        return v = e.allocUnsafe ? e.allocUnsafe(u.length) : new e(u.length),
                                                            u.copy(v),
                                                            v;
                                                ...
                                                if (Object.getOwnPropertySymbols) {
                                                    ...
                                                    for (m = 0; m < O.length; m++) {
                                                        var w = O[m];
                                                        (!(x = Object.getOwnPropertyDescriptor(u, w)) || x.enumerable || f) && (v[w] = l(u[w], y - 1),
                                                        x.enumerable || Object.defineProperty(v, w, {
                                                            enumerable: !1
                                                        }))
                                                    }
                                                }
                                                if (f) {
                                                    var E = Object.getOwnPropertyNames(u);
                                                    for (m = 0; m < E.length; m++) {
                                                        var x, k = E[m];
                                                        (x = Object.getOwnPropertyDescriptor(u, k)) && x.enumerable || (v[k] = l(u[k], y - 1),
                                                            ...
                                                            if (0 !== l.length) {
                                                                ...
                                                                if (null != s && t.quill.hasFocus()) {
                                                                    var u = t.quill.getLine(s.index)
                                                                        ...
                                                                        , E = _ instanceof f.default.Text ? _.value().slice(O) : ""
                                                                        , x = {
                                                                                ...
                                                                                if (e.format.every((function(t) {
                                                                                    ...
                                                                                    return !1
                                                                                        ...
                                                                                        return !0 === e.format[t] ? null != x.format[t] : !1 === e.format[t] ? null == x.format[t] : (0,
                                                                                            a.default)(e.format[t], x.format[t])
                                                                                    }
                                                                                )))
                                                                                return !1;
                                                                            return !(null != e.prefix && !e.prefix.test(x.prefix) || null != e.suffix && !e.suffix.test(x.suffix) || !0 === e.handler.call(t, s, x))
                                                                        }
                                                                    )) && n.preventDefault()
                                                                }
                                                            }
                                            ...
                                            value: function(t, e) {
                                                ...
                                                this.pickers = t.map((function(t) {
                                                        if (t.classList.contains("ql-align"))
                                                            return null == t.querySelector("option") && x(t, b),
                                                        ...
                                                        if (t.classList.contains("ql-background") || t.classList.contains("ql-color")) {
                                                            ...
                                                            return null == t.querySelector("option") && x(t, g, "background" === n ? "#ffffff" : "#000000"),
                                                                new u.default(t,e[n])
                                                        }
                                                        return null == t.querySelector("option") && (t.classList.contains("ql-font") ? x(t, m) : t.classList.contains("ql-header") ? x(t, _) : t.classList.contains("ql-size") && x(t, O)),
                                                            new f.default(t)
                                                    }
                                                )),
                                            ...
                                            value: function() {
                                                ...
                                                switch (this.root.getAttribute("data-mode")) {
                                                    case "link":
                                                        ...
                                                        this.linkRange ? (this.quill.formatText(this.linkRange, "link", n, l.default.sources.USER),
                                                            delete this.linkRange) : (this.restoreFocus(),
                                                            this.quill.format("link", n, l.default.sources.USER)),
                                                    ...
                                                    case "formula":
                                                        ...
                                                        if (null != o) {
                                                            ...
                                                            this.quill.insertEmbed(i, this.root.getAttribute("data-mode"), n, l.default.sources.USER),
                                                            "formula" === this.root.getAttribute("data-mode") && this.quill.insertText(i + 1, " ", l.default.sources.USER),
                                                                this.quill.setSelection(i + 2, l.default.sources.USER)
                                                        }
                                                }
                                                this.textbox.value = "",
                                                    this.hide()
                                        ...
                                        return function(t, e) {
                                            ...
                                            for (var f = n - o, h = f % 2 != 0, p = 0, d = 0, y = 0, v = 0, b = 0; b < i; b++) {
                                                ...
                                                for (var w = -b + y; w <= b - v; w += 2) {
                                                    for (var E = l + w, x = (O = w == -b || w != b && u[E - 1] < u[E + 1] ? u[E + 1] : u[E - 1] + 1) - w; O < n && x < o && t.charAt(n - O - 1) == e.charAt(o - x - 1); )
                                                        O++,
                                                            x++;
                                                    if (u[E] = O,
                                                        O > n)
                            ...
                            , function(t, e, n) {
                                ...
                                var O = (0,
                                    ...
                                    , w = "__ql-matcher"
                                    , E = [[Node.TEXT_NODE, M], [Node.TEXT_NODE, L], ["br", function(t, e) {
                                    return T(e, "\n") || e.insert("\n"),
                                        e
                                }
                                ], [Node.ELEMENT_NODE, L], [Node.ELEMENT_NODE, C], [Node.ELEMENT_NODE, R], [Node.ELEMENT_NODE, q], [Node.ELEMENT_NODE, function(t, e) {
                                    var n = {}
                                        , r = t.style || {};
                                    return r.fontStyle && "italic" === j(t).fontStyle && (n.italic = !0),
                                    r.fontWeight && (j(t).fontWeight.startsWith("bold") || parseInt(j(t).fontWeight) >= 700) && (n.bold = !0),
                                    ...
                                    , x = [h.AlignAttribute, v.DirectionAttribute].reduce((function(t, e) {
                                    ...
                                    function e(t, n) {
                                        ...
                                        return r.quill.root.addEventListener("paste", r.onPaste.bind(r)),
                                            ...
                                            r.matchers = [],
                                            E.concat(r.options.matchers).forEach((function(t) {
                                                    var e = o(t, 2)
                                                        , i = e[0]
                                                        , l = e[1];
                                ...
                                function q(t, e) {
                                    ...
                                    return n.concat(r).concat(o).forEach((function(e) {
                                            ...
                                            null != n && (i[n.attrName] = n.value(t),
                                                i[n.attrName]) || (null == (n = x[e]) || n.attrName !== e && n.keyName !== e || (i[n.attrName] = n.value(t) || void 0),
                                            null == (n = k[e]) || n.attrName !== e && n.keyName !== e || (n = k[e],
                                ...
                                function C(t, e) {
                                    ...
                                    if (n.prototype instanceof s.default.Embed) {
                                        ...
                                        "function" == typeof n.formats && (e = N(e, n.blotName, n.formats(t)));
                                    return e
                                }
                                function L(t, e) {
                                ...
                                function R(t, e) {
                                    if (P(t) && null != t.nextElementSibling && !T(e, "\n\n")) {
                                ...
                                function M(t, e) {
                                    ...
                                    if (!j(t.parentNode).whiteSpace.startsWith("pre")) {
                                        ...
                                        (null == t.previousSibling && P(t.parentNode) || null != t.previousSibling && P(t.previousSibling)) && (n = n.replace(/^\s+/, r.bind(r, !1))),
                                        (null == t.nextSibling && P(t.parentNode) || null != t.nextSibling && P(t.nextSibling)) && (n = n.replace(/\s+$/, r.bind(r, !1)))
                                    }
                                    return e.insert(n)
                                }
                                A.DEFAULTS = {
 ...
 */
                ...
                function b(t, e, n, r, o) {
                    ...
                    if ("number" == typeof e)
                        return e &= 255,
                            s.TYPED_ARRAY_SUPPORT && "function" == typeof Uint8Array.prototype.indexOf ? o ? Uint8Array.prototype.indexOf.call(t, e, n) : Uint8Array.prototype.lastIndexOf.call(t, e, n) : g(t, [e], n, r, o);
                ...
                s.prototype.slice = function(t, e) {
                    ...
                    s.prototype.writeUIntLE = function(t, e, n, r) {
                        (t = +t,
                            e |= 0,
                            n |= 0,
                            r) || q(this, t, e, n, Math.pow(2, 8 * n) - 1, 0);
                        var o = 1
                            , i = 0;
    ...
    20: function(t, e, n) {
        ...
        e.byteLength = function(t) {
            ...
            e.toByteArray = function(t) {
                var e, n, r = u(t), l = r[0], a = r[1], s = new i(function(t, e, n) {
                    return 3 * (e + n) / 4 - n
                }(0, l, a)), c = 0, f = a > 0 ? l - 4 : l;
                for (n = 0; n < f; n += 4)

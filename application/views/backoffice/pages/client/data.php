							...
							<td width="1%" class="text-center">
								<div class="dropdown">
									...
									<div class="dropdown-menu">
										<a class="dropdown-item" href="javascript:void(0);" onclick="ubah('<?= $val[$this->id] ?>')"><i class="bx bx-edit-alt me-2"></i>Edit</a>
										<a class="dropdown-item" href="javascript:void(0);" onclick="hapus('<?= $val[$this->id] ?>')"><i class="bx bx-trash me-2"></i>Delete</a>
									</div>
								</div>
							</td>
							<td><img src='<?=$val["image"]==''?$this->noImage:$val['image']?>' style='height:50px;max-width: 100px;border-radius: 10px' alt=''></td>
							<td ><?=$val['name']?></td>
							<td ><a href="<?=$val['youtube']?>" target="_blank"><?=$val['youtube']?></a></td>
						</tr>

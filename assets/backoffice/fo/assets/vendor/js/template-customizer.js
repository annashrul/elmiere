							...
							if (
								...
								if (
									((this.settings = {}),
										...
										(this.settings.defaultNavbarType = void 0 !== m ? m : N),
								...
								(this.settings.onSettingsChange = "function" == typeof M ? M : function () {}),
									this._loadSettings(),
									(this._listeners = []),
									(this._controls = {}),
									this._initDirection(),
									...
									},
									{
										...
										value: function (e) {
											...
											if (e !== this.settings.lang || s) {
												...
												for (var n = a.themes || {}, o = this.container.querySelectorAll(".template-customizer-theme-item") || [], r = 0, l = o.length; r < l; r++) {
										...
										value: function () {
											...
											"" !== i || "" !== s || "" !== a || "" !== n || "" !== o || "" !== l || "" !== u ? this._showResetBtnNotification(!0) : this._showResetBtnNotification(!1),
												...
												"system" === this.settings.stylesOpt
													...
													: ((document.cookie = "style=; expires=Thu, 01 Jan 2000 00:00:00 UTC; path=/;"), (this.settings.style = -1 !== this.settings.styles.indexOf(s) ? s : this.settings.defaultStyle)),
										...
										value: function () {
											...
											if (this._hasControls("rtl headerType contentLayout layoutCollapsed layoutNavbarOptions", !0)) {
												...
												if (this._hasControls("headerType")) {
													var w = x.querySelector(".template-customizer-header-options");
													setTimeout(function () {

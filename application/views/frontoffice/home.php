				...
				<ul>
					...
					foreach ($slider as $row): $no++ ?>
						<li data-index="rs-6<?= $no ?>" data-transition='fade' data-slotamount='default'
							...
							<img src="<?= $url. $row['image'] ?>" alt data-bgposition='center center'
	...
	<section id='about' class='about-area about-1 section-padding' style="background-color: whitesmoke !important;">
		<div class='container'>
			<div class='row'>
				<div class='col-md-6'>
	...
	<!---->
	<!--						</ul>-->
							<p class="wow fadeInUp" data-wow-delay=".75s"><?=$about['caption']?></p>
						</div>
					</div>
				</div>
			</div>
			...
			<div class='row'>
				<div class='col-md-12'>
					<div class='section-titleV1'>
						...
						<a style="color: black" href="<?=base_url().'photos'?>"><u>See All</u></a>
			...
			<div class='row'>
				<div class='col-md-12'>
					<div class='section-titleV1'>
						...
						<a style='color: black' href="<?= base_url() . 'gallery' ?>"><u>See All</u></a>
			...
			<div class='row'>
				<div class='col-md-12'>
					<div class='section-titleV1'>
						...
						<h3 class='wow fadeInUp text-white' data-wow-delay='.25s'>clients feedbacks</h3>
					</div>
				</div>
			</div>
			<div class='row'>
					...
					<div id='sync1' class='imagePorto testimonial-carouselV1 owl-carousel owl-theme wow fadeInUp'>
						<?php foreach ($this->M_crud->read_data('partner', '*') as $row): ?>
							<div class='item' style="text-align: center!important;">
								<img src="<?= $row['image'] ?>" style='vertical-align: middle !important;'>
							</div>
						<?php endforeach; ?>
					</div>
				</div>
	...
	<section class='exclusive-service-area section-padding'>
		<div class='container'>
			<div class='row'>
				<div class='col-md-12'>
					<div class='section-titleV1'>
						<p class='wow fadeInUp' data-wow-delay='.15s'>OUR SERVICES</p>
						<h3 class='wow fadeInUp' data-wow-delay='.35s'>EXCLUSIVE SERVICES</h3>
					</div>
				</div>
			</div>
			<div class='row'>

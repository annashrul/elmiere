				...
				<table class="table border-top table-hover">
					...
					<?php foreach ($row as $val):
						...
						<tr>
							...
							<td >
								<div onclick="showImage('<?=$this->url.$val['poto']?>|<?=$val['nama']?>')" class='d-flex align-items-center pointer'>
									<img src="<?=$this->url.$val['poto']?>" alt='Chrome'  class='avatar me-2 rounded-circle'>
									<span><?=$val['nama']?></span>
								</div>
							</td>
							...
							<td ><?=$val['nama_kelas']?> - <?=$val['nama_keahlian']?></td>
